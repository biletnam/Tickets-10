...
if ($id > 0) {
  ...
  if (count($projectInfo) > 0) {
    ...
    $page->add('title',  $projectInfo['pagetitle'] = $runtime->doTemplate($module, 'title.project', $projectInfo);
    $page->add('main', $runtime->doTemplate($module, 'project', $projectInfo);
  } else {
    $page->add('title',  $projectInfo['pagetitle'] = $runtime->doTemplate($module, 'title.project.notfound');
    $page->add('main', $runtime->doTemplate($module, 'project.notfound', $projectInfo);
  }
}
