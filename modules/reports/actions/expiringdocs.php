...
$basequery = $runtime->spreview($module, 'ExpiringDocuments', $_REQUEST); #print $basequery;
$grid1 = new ctlDataGrid($r, 'expiringdocs', $basequery, $module);
$descriptor = $runtime->txt->get_module_file($module, 'sql/ExpiringDocuments.columns.txt');
