...
if (count($userInfo) == 0) {
  ...
  if ($user_id == $r['userID']) {
    $page->add('title',  $pageParams['pagetitle'] = $runtime->doTemplate($module, 'title.mytickets2handle', $pageParams);  
    $page->add('main', $runtime->doTemplate($module, 'mytickets2handle', $pageParams);  
  } else {
    ...
    $page->add('main', $runtime->doTemplate($module, 'usertickets2handle', $pageParams);  
  }
} else {
  $page->add('title',  $pageParams['pagetitle'] = $runtime->doTemplate($module, 'title.usertickets2handle', $userInfo);  
