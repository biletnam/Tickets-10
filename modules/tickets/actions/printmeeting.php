...
if ($id <> '') {
  ...
  $page->add('title',  $meetingInfo['pagetitle'] = $runtime->doTemplate($module, 'title.printmeeting', $meetingInfo);
  if ($access == 'none') {
    $page->add('main', $runtime->doTemplate($module, 'viewmeeting.noaccess');
