...
if ($id <> '') {
  ...
  if (count($pollInfo) > 0) {
    ...
    $page->add('main', $r->txt->do_template($module, 'notfound', $pageParams);
  }
  ...
  if ($access == 'none') {
    ...
    $page->add('title',  $pollInfo['pagetitle'] = $r->txt->do_template($module, 'title.edit', $pollInfo);
    ...
    $page->add('main', $r->txt->do_template($module, 'edit', $pollInfo);
  }
} else {
