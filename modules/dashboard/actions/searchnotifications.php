...
foreach $eD (reverse sort keys %nn) {
  ...
  $nhash['day'] = $r->txt->do_template($module, 'notifications.day.withyear', ${$n[0]});
...
$pageParams['pagetitle'] = $page->add('title',  $r->txt->do_template($module, 'title.searchnotifications');
$page->add('main', $r->txt->do_template($module, 'searchnotifications', $pageParams);
