...
if ($id > 0) {
  ...
  if (count($bookreqInfo) > 0) {
    $page->add('title',  $bookreqInfo['pagetitle'] = $runtime->doTemplate($module, 'title.view', $bookreqInfo);
    ...
    if ($status == 'NEW') {
      ...
      $page->add('main',  $runtime->doTemplate($module, 'view.new', $bookreqInfo);
    } else {
      $page->add('main',  $runtime->doTemplate($module, 'view', $bookreqInfo);
    }
  } else {
    $page->add('main', $runtime->doTemplate($module, 'view.notfound');    
  }
}
