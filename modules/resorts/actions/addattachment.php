...
if ($hotel > 0) {
  ...
  if ($fileid > 0) {
    ...
    if ($id > 0) {
      ...
      $subject = $runtime->doTemplate($module, 'notification.attachment.added.subject', $hotelInfo);
      $body = $runtime->doTemplate($module, 'notification.attachment.added.body', $attachmentInfo);
