...
if ($id <> '') {
  ...
  $pageParams['pagetitle'] = $page->add('title',  $runtime->txt->do_template($module, 'editapartmenttype.title', $pageParams); 
} else {
  %pageParams = array('hotel' => lavnn('hotel'), 'block' => lavnn('block'));
  $pageParams['hotelinfo'] = hash2ref(s2r($module, 'GetHotelInfo', array('id' => $pageParams['hotel'])));
  $pageParams['pagetitle'] = $page->add('title',  $runtime->txt->do_template($module, 'editapartmenttype.new.title', $pageParams); 
}
...
$page->add('main', $runtime->txt->do_template($module, 'editapartmenttype', $pageParams);
