...
if ($provider > 0) {
  ...
  $page->add('title',  $providerInfo['pagetitle'] = $r->txt->do_template($module, 'title.providerdetails', $providerInfo);
  $page->add('main', $r->txt->do_template($module, 'providerdetails', $providerInfo);
}
