...
if ($id <> 0) {
  ...
  if ($office <> 0) {
    ...
    if (count($pageParams) > 0) {
      $pageParams['pagetitle'] = $runtime->doTemplate($module, 'title.balances', $pageParams);
      ...
      $page->add('title',  $pageParams['pagetitle'] = $runtime->doTemplate($module, 'title.balances', $pageParams);
      $page->add('main', $runtime->doTemplate($module, 'balances', $pageParams);
    }  
  }
}
