...
if ($id > 0) {
  ...
  $calendarInfo['pagetitle'] = $runtime->doTemplate($module, 'title.officecalendar.edit', $calendarInfo);  
  ...
  $calendarInfo['pagetitle'] = $runtime->doTemplate($module, 'title.officecalendar.new', $officeInfo);
}
if ($acc->is_superadmin() && $calendarInfo['cnt_employees'] == 0) {
  ...
  $calendarInfo['move2office'] = $runtime->doTemplate($module, 'officecalendar.move2office', $calendarInfo);
}
$page->add('title',  $calendarInfo['pagetitle'];
$page->add('main', $runtime->doTemplate($module, 'officecalendar', $calendarInfo);
