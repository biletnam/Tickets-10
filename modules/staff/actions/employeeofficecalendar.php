...
if ($id > 0) {
  ...
  $employeeOfficeCalendarInfo['pagetitle'] = $r->txt->do_template($module, 'title.employeeofficecalendar.edit', $employeeOfficeCalendarInfo);
  ...
  $employeeOfficeCalendarInfo['pagetitle'] = $r->txt->do_template($module, 'title.employeeofficecalendar.new', $employeeInfo);
}
if ($office_id <> 0) {
...
$page->add('main', $r->txt->do_template($module, 'employeeofficecalendar', $employeeOfficeCalendarInfo);
