...
if ($id > 0) {
  ...
  $page->add('title',  $typeInfo['pagetitle'] = $runtime->txt->do_template($module, 'title.settings.contacttypes.edit');
} else {
  %typeInfo = array();
  $page->add('title',  $typeInfo['pagetitle'] = $runtime->txt->do_template($module, 'title.settings.contacttypes.new');
}
...
$page->add('main', $runtime->txt->do_template($module, 'settings.contacttypes.edit', $typeInfo);
